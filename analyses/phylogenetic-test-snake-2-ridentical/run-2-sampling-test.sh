...
cd /net/viral_genomics/covid-lineage/huge-lineage-dynamics/analyses/phylogenetic-test-snake-2-ridentical/
DATE_TREE=20210602
...
for X in $SUB_TREES; do
	scripts/filter-alignment-distance <( cat temp/lin-ius-3/query-ids.txt temp/lin-ius-3/sample-idx.txt ) <( zcat $OLD/results/beast/run/lin-ius/alignment-distance-$DATE_TREE-$X-id.txt.gz )
