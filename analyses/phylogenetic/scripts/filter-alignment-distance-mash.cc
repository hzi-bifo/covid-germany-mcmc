...
cd /net/viral_genomics/covid-lineage/huge-lineage-dynamics/analyses/phylogenetic-test-snake-2/
DATE_TREE=20210602
...
python scripts/compare-sequences-mash.py temp/lin-ius-3/alignment-distance-injected.txt temp/lin-ius-3/match-ids.txt 
