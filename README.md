...
The effectiveness evaluation results for the main sampling are available [here](analyses/phylogenetic-test-snake-2-nounsampled/results/beast/run/lin-ius-3/daily-effectiveness-germany.tsv).
