...
```{r load-data, cache=TRUE}
    ...
    for (i in 1:nrow(stateFiles)) {
      ...
      clusterStatsMCC   <- read.table(paste0(outputpath, "clusters_", cluster_f, "_MCC.tsv"), sep="\t", head=TRUE, na.strings=c("NA", ""), fill=TRUE, stringsAsFactors=FALSE, quote="|")
      ...
      clusterSamplesMCC <- read.table(paste0(outputpath, "clusterSamples_", cluster_f, "_MCC.tsv"), sep="\t", head=TRUE, na.strings=c("NA", ""), fill=TRUE, stringsAsFactors=FALSE, quote="|")
